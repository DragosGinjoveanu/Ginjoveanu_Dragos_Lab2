...
namespace Ginjoveanu_Dragos_Lab2.Data
{
    public class Ginjoveanu_Dragos_Lab2Context : DbContext
    {
        ...
        public DbSet<Ginjoveanu_Dragos_Lab2.Models.Member> Member { get; set; } = default!;
        
        public DbSet<Ginjoveanu_Dragos_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
